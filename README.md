...
**If you just want to play around with the phrase counts and conditional probabilities**: Skip points 1, 2, and 3, and start with 4 (_Tallying color/animal phrases_) and the files produced in that section.
